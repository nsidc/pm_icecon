...
See the docstring for get_nt_tiepoint_table() for more details
...
if __name__ == '__main__':
    ...
    # Table is definied above
    nt_tiepoint_table = get_nt_tiepoint_table()
    ...
    tiepoint = nt_tiepoint_table[sat][hem][freq][tp]
    print(f'  nt_tiepoint_table[{sat}][{hem}][{freq}][{tp}]: {tiepoint}')
