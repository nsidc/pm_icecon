...
def compute_linreg(
        ...
        newsat,
        d,
        fn_landmask='./pss25_expanded_landmask.dat',
    ...
    valid = np.fromfile(fn_valid_.format(hem=hem, h=h,
...
if __name__ == '__main__':
    ...
    if ymd == 'do all':
        ...
        while d <= dt.date(2021, 12, 31):
            compute_linreg('f17', 'a2', d, hem='sh')

            d += dt.timedelta(days=1)
    else:
        compute_linreg('f17', 'a2', ymd, hem='sh')
