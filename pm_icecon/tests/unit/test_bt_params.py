"""Test that the BT params are not changing unexpectedly.
...
def _get_config_hash(cfg) -> str:
    """Returns a string representing the m5 of the data in `cfg`"""
    json_str = json.dumps(
        cfg,
...
def test_amsr2_goddard_params():
    ...
    assert _get_config_hash(amsr2_goddard_params.AMSR2_NORTH_PARAMS) == 'd1612e6dea7635908a610205c0c0b37a'
    assert _get_config_hash(amsr2_goddard_params.AMSR2_SOUTH_PARAMS) == 'a6fea626f1f1c51de2c74831f1d99e59'


def test_amsr2_params():
    """Assert that NSIDC's update to the weather filter params have not changed."""
    assert _get_config_hash(amsr2_params.AMSR2_NORTH_PARAMS) == '8e691fd9f83cae18f186f454897c15c5'
    assert _get_config_hash(amsr2_params.AMSR2_SOUTH_PARAMS) == 'f9bd22a2d2c48a874d89c51cb2480436'
